...
(function (c) {
    ...
    d["default"] = (function () {
        function g(r, s, q, p) {
            ...
            this.getCoordinates = function (y) {
                var x = [], v = this.xoffset, z = this.yoffset, w = j(y) / this.height, u = j(y) / this.width;
    ...
    var a = {HORIZONTAL: 0, VERTICAL: 1, BOTH: 2};
    c.extend(c.jqx._jqxTreeMap.prototype, {defineInstance: function () {
        var e = {width: 600, height: 600, renderCallbacks: {}, legendScaleCallback: function (f) {
            return f
        }, hoverEnabled: false, selectionEnabled: true, singleSelection: true, showLegend: true, legendLabel: "Legend", headerHeight: 25, colorRange: 100, layout: "default", source: [], displayMember: null, valueMember: null, colorMode: "parent", baseColor: "#C2EEFF", legendPosition: {x: 0, y: 0}, colorRanges: [
        ...
        var f = new c.jqx.dataAdapter(e, {autoBind: false});
        if (h) {
            f = e;
            e = e._source
        }
        ...
        this.host.css({position: "relative", width: this.width, height: this.height});
        var e = false;
        ...
        g = o._toHex({r: Math.max(k.r - f, 0), g: Math.max(k.g - f, 0), b: Math.max(k.b - f, 0)});
        return g
    }, parent: function (g) {
        ...
        var j = c("<div/>"), e = i[2] - i[0], l = i[3] - i[1];
        var g = this._getColor(f);
        j.css({position: "absolute", left: i[0] - 1, top: i[1] - 1, width: e, height: l, backgroundColor: g});
        j.addClass(this.toThemeProperty("jqx-treemap-rectangle"));
        var k = this._colorEvaluator;
        var h = {data: f.data, label: f.label, value: f.value, parent: f.parent, record: f.record, color: g, rgb: k._toRgb(g)};
        ...
        var n = this._getValues(f.children), g = f.area.offset(), j = l(n, f.area.width(), f.area.height() - e, 0, e), k, m;
        for (var h = 0; h < f.children.length; h += 1) {
            k = f.children[h];
            m = this._renderRect(j[h], k);
            k.area = m;
            f.area.append(m);
            this._addHandlers(m, {label: k.label, value: k.value, color: k.color, sector: k.area, data: k.data});
        ...
        var n = this._getValues(f.children), g = f.area.offset(), h = l(n, f.area.width(), f.area.height() - e, 0, e), m;
        ...
        j.css({left: i[0] - 1, top: i[1] - 1, width: e, height: l});
        var k = this._colorEvaluator;
        var g = this._getColor(f);
        var h = {data: f.data, label: f.label, value: f.value, parent: f.parent, record: f.record, color: g, rgb: k._toRgb(g)};
        if (f.parent == this._root) {
        ...
        var l = this._getBoundValues(), g = 5, e = l[1].value, j = l[0].value, f = (e - j) / g, m, k = [];
        for (var h = j; h < e; h += f) {
            m = Math.round(h);
            k.push({min: m, max: h + f, color: this._colorEvaluator.getColorByValue.call(this, m, this._dataList, this.baseColor)})
        }
        return k
        ...
        var g = c('<tr><td colspan="' + f.find("td").length / 2 + '"/></tr>'), e = c('<div class="' + this.toThemeProperty("jqx-treemap-legend-label") + '" />');
        e.text(this.legendLabel);
        g.children().append(e);
        f.prepend(g)
    }, _renderColorLegend: function (e) {
        var o = c('<div class="' + this.toThemeProperty("jqx-treemap-legend") + '"/>'), q, n, r, p = function (i) {
            return i
        };
        ...
        o.css({position: "absolute", left: this.legendPosition.x, bottom: this.legendPosition.y, visibility: (this.showLegend) ? "visible" : "hidden"});
        return o
