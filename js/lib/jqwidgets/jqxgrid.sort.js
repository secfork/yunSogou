...
(function (a) {
    a.jqx.dataview.sort = function () {
        this.sortby = function (d, f, p) {
                ...
                if (r.length) {
                    ...
                    if (l) {
                        a.each(r, function (u, v) {
                            b.push({sortkey: v.toString(), value: v, index: u})
                        })
                    }
                }
            }
            ...
            this.sortdata = b;
            this.sortcache[g] = {_sortdata: b, direction: f};
    ...
    a.extend(a.jqx._jqxGrid.prototype, {_rendersortcolumn: function () {
        var b = this.that;
        ...
        if (this.sortdirection) {
            ...
            if (this._oldsortinfo) {
                if (this._oldsortinfo.column) {
                    c(this._oldsortinfo.column, {ascending: false, descending: false})
                }
            }
        ...
        if (d != undefined) {
            ...
            if (g != null) {
                c.sortdirection = {ascending: ascending, descending: !ascending}
            } else {
                c.sortdirection = {ascending: false, descending: false}
            }
            if (g != null) {
                c.sortcolumn = d
            } else {
