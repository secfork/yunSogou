...
(function (a) {
    ...
    a.extend(a.jqx._jqxProgressBar.prototype, {defineInstance: function () {
        ...
        c.remove();
        return b
    }, _initialRender: true, refresh: function () {
        ...
        try {
            ...
            if (this.orientation == "horizontal") {
                ...
                a(m).animate({width: c, left: e + "px"}, this.animationDuration, function () {
                    if (j._value() === j.max) {
                ...
                this.feedbackElementHost.animate({"margin-top": -(p.toFixed(0) * j.host.height()) / 100}, this.animationDuration, function () {
                });
                a(m).animate({height: n, top: d + "px"}, this.animationDuration, function () {
                    var q = j._percentage();
                    if (isNaN(q)) {
                        q = 0
                    }
        ...
        this.feedbackElement.css({left: (o), "margin-top": -parseInt(k) / 2 + "px"})
    }})
})(jqxBaseFramework);