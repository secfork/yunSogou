...
(function (a) {
    a.extend(a.jqx._jqxGrid.prototype, {getcolumnindex: function (b) {
        ...
        this._raiseEvent(24, {columntext: g.text, datafield: g.datafield, oldindex: k, newindex: h});
        if (i == false) {
            return
        }
        ...
        this.addHandler(a(document), f, function (j) {
            ...
            if (d.reordercolumn != null) {
                ...
                d.reordercolumn.css({left: q + "px", top: i + "px"});
                c = false;
        ...
        this.addHandler(a(document), e, function (j) {
            ...
            a.each(d.columns.records, function (n) {
                var o = this;
                if (o.hidden) {
                    d.columnsbounds[d.columnsbounds.length] = {top: k, column: o, left: l, width: 0, height: 2 + d.rowsheight};
                    return true
                }
                if (i == 0) {
                    if (!d.rtl) {
                ...
                d.columnsbounds[d.columnsbounds.length] = {top: k, column: o, left: l, width: o.width, height: m};
                l += o.width
            })
        });
