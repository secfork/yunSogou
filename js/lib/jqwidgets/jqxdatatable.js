...
(function (b) {
    ...
    b.extend(b.jqx._jqxDataTable.prototype, {defineInstance: function () {
        ...
        if (!q && j > g && (this.source.records.length > 0 || this.source.hierarchy.length > 0)) {
        ...
        if (o > r && !p) {
            ...
            n = 4 + parseInt(d);
            if (!q) {
                if (j > g - n + 4 && (this.source.records.length > 0 || this.source.hierarchy.length > 0)) {
        ...
        var e = this.getColumn(s);
        this._raiseEvent("cellValueChanged", {value: w, oldValue: n, dataField: s, displayField: e.displayfield, key: D, boundIndex: k, index: C, row: this.rowsByKey[D]});
        if (this.editable) {
        ...
        if (E) {
            ...
            this._raiseEvent("cellBeginEdit", {value: v, displayValue: l, key: G, index: F, dataField: q.datafield, displayField: q.displayfield, boundIndex: n, row: this.rowsByKey[G]})
        }
                ...
                if (d) {
                    ...
                    var s = function () {
                        ...
                        for (var x = 0; x < m.length; x++) {
                            ...
                            if (C != u) {
                                k.beginUpdate();
                                k._raiseEvent("cellValueChanged", {value: C, oldValue: u, dataField: v.datafield, displayField: v.displayfield, key: p, index: l, row: t});
                                k.endUpdate(false)
                            }
                        }
                    };
        ...
        if (p != undefined) {
            ...
            var g = function (r, q, u, e) {
                ...
                r.dataview._filteredData = null;
                r.dataview._sortData = null;
                r.dataview._sortHierarchyData = null;
        ...
        for (var am = 0; am < ai.length; am++) {
            ...
            ar += E;
            if (!this.rowinfo[G.uid]) {
                this.rowinfo[G.uid] = {group: Y, row: G, details: null, detailsHeight: 200, initialized: false, expanded: false}
            } else {
            ...
            if (this.source && this.source.getAggregatedData) {
                ...
                if (d == undefined || d == true) {
                    var m = this.source.getAggregatedData([
                        {name: k.datafield, aggregates: e, formatStrings: f}
