...
(function (a) {
    a.extend(a.jqx._jqxGrid.prototype, {_handledblclick: function (t, n) {
            ...
            if (J == 32) {
                if (y.editcell.columntype == "checkbox") {
                    ...
                    if (f.editable) {
                        ...
                        y._raiseEvent(18, {rowindex: y.editcell.row, row: k, datafield: y.editcell.column, oldvalue: !o, value: o, columntype: "checkbox"});
                        return false
                    }
                }
            }
                ...
                if (g != null && g.length > 0) {
                    for (var r = 0; r < g.length; r++) {
                        ...
                        if (F !== "" && f.editable && y.enablekeyboarddelete) {
                            ...
                            y._raiseEvent(17, {rowindex: c.rowindex, row: k, datafield: c.datafield, value: F});
                            if (r == g.length - 1) {
                            ...
                            y._raiseEvent(18, {rowindex: c.rowindex, row: k, datafield: c.datafield, oldvalue: F, value: j})
                        }
                    }
            ...
            if (J == 32) {
                ...
                if (c != null) {
                    ...
                    if (f.columntype == "checkbox" && f.editable) {
                        ...
                        var k = y.getrowdata(c.rowindex);
                        y._raiseEvent(17, {rowindex: c.rowindex, row: k, datafield: c.datafield, value: !o, columntype: "checkbox"});
                        y.setcellvalue(c.rowindex, c.datafield, o, true);
                        y._raiseEvent(18, {rowindex: c.rowindex, row: k, datafield: c.datafield, oldvalue: !o, value: o, columntype: "checkbox"});
                        return false
                    }
                }
            }
            ...
            switch (h.columntype) {
                ...
                case"datetimeinput":
                    if (l.jqxDateTimeInput) {
                        l.jqxDateTimeInput({isEditing: false});
        ...
        this.popups[this.popups.length] = {validation: g, validationrow: r}
