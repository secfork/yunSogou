...
var pdfDataExport = (function () {
    ...
    function b(D, ad, L, U) {
        ...
        var aq = L.toString().toLowerCase(), am = "0.9.0rc2", s = [], E = 0, at = U, T = "1.3", M = {a3: [841.89, 1190.55], a4: [595.28, 841.89], a5: [420.94, 595.28], letter: [612, 792], legal: [612, 1008]}, ac = "0 g", G = "0 G", g = 0, f = [], m = 2, u = false, C = [], ag = {}, P = {}, ah = 16, d, y = 0.200025, A, B, ai, N = {title: "", subject: "", author: "", keywords: "", creator: ""}, Q = 0, S = 0, O = {}, F = new a(O), ae, ao, o = function (i) {
            return i.toFixed(2)
        }, n = function (i) {
            return i.toFixed(3)
        }, z = function (i) {
            ...
            var aw = "F" + (c(ag) + 1).toString(10), k = ag[aw] = {id: aw, PostScriptName: i, fontName: av, fontStyle: ax, encoding: au, metadata: {}};
            l(aw, av, ax);
            F.publish("addFont", k);
            return aw
        }, e = function () {
            var k = "helvetica", aD = "times", aF = "courier", aC = "normal", aB = "bold", aA = "italic", aE = "bolditalic", au = "StandardEncoding", ax = [
                ["Helvetica", k, aC],
                ["Helvetica-Bold", k, aB],
            ...
            F.publish("addFonts", {fonts: ag, dictionary: P})
        }, r = function (aE, av) {
            ...
            F.publish("addPage", {pageNumber: g})
        }, x = function (au, aw) {
            var i, k;
            if (au === k) {
                au = ag[d].fontName
            ...
            switch (ax) {
                ...
                case"save":
                    ...
                    k = new Blob([aA], {type: "application/pdf"});
                    saveAs(k, au);
                    break;
                case"datauristring":
                case"dataurlstring":
        ...
        O.internal = {pdfEscape: Y, getStyle: ab, getFont: function () {
            return ag[x.apply(O, arguments)]
        }, getFontSize: function () {
            return ah
        }, btoa: btoa, write: function (i, av, au, k) {
            ...
            return o((A - i) * ai)
        }, collections: {}, newObject: v, putStream: J, events: F, scaleFactor: ai, pageSize: {width: B, height: A}, output: function (k, i) {
            return H(k, i)
        }};
        O.addPage = function () {
            af();
        ...
        O.ellipse = function (i, az, ax, aw, k) {
            var ay = ab(k), av = 4 / 3 * (Math.SQRT2 - 1) * ax, au = 4 / 3 * (Math.SQRT2 - 1) * aw;
        ...
        O.CapJoinStyles = {0: 0, butt: 0, but: 0, bevel: 0, 1: 1, round: 1, rounded: 1, circle: 1, 2: 2, projecting: 2, project: 2, square: 2, milter: 2};
...
(function (i) {
    ...
    i.cell = function (v, u, z, r, p, t) {
        ...
        var A = k(), q = this.getTextDimensions(p), s = 1;
