...
(function (a) {
    ...
    a.extend(a.jqx._jqxDropDownButton.prototype, {defineInstance: function () {
        ...
        var b = {setContent: function (d) {
            ...
            if (c.touch) {
                c.addHandler(a(document), a.jqx.mobile.getTouchEventName("touchstart") + "." + c.element.id, d.closeOpenedDropDown, {me: this, popup: c.container, id: c.element.id})
            }
            c.addHandler(a(document), "mousedown." + c.element.id, d.closeOpenedDropDown, {me: this, popup: c.container, id: c.element.id});
            ...
            h.top -= Math.min(h.top, (h.top + l > g && g > l) ? Math.abs(l + e + 22) : 0);
            return h
            ...
            if (l.enableBrowserBoundsDetection) {
                var k = l.testOffset(d, {left: parseInt(l.container.css("left")), top: parseInt(n)}, parseInt(l.host.outerHeight()));
                if (parseInt(l.container.css("top")) != k.top) {
                    ...
                    l.interval = setInterval(function () {
                        if (d.outerHeight() != r.container.height()) {
                            var t = r.testOffset(d, {left: parseInt(r.container.css("left")), top: parseInt(n)}, parseInt(r.host.outerHeight()));
            ...
            if (l.animationType == "none") {
                ...
                if (l.animationType == "fade") {
                    d.css("margin-top", 0);
                    d.css("opacity", 0);
                    d.animate({opacity: 1}, l.openDelay, function () {
                        a.data(document.body, "openedJQXButtonParent", r);
                    ...
                    m.call(r);
                    d.animate({"margin-top": 0}, l.openDelay, function () {
                        a.data(document.body, "openedJQXButtonParent", r);
                        a.data(document.body, "openedJQXButton" + r.element.id, d);
                        r.ishiding = false;
                        r.isanimating = false;
            ...
            if (i.animationType == "none") {
                ...
                if (!h.ishiding) {
                    ...
                    if (i.animationType == "fade") {
                        g.css({opacity: 1});
                        g.animate({opacity: 0}, i.closeDelay, function () {
                        ...
                        g.animate({"margin-top": j}, i.closeDelay, function () {
                            f.css("visibility", "hidden");
                            h.isanimating = false;
                            h.ishiding = false;
                            if (e) {
