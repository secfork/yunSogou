...
(function (a) {
    a.extend(a.jqx._jqxChart.prototype, {_moduleAnnotations: true, _renderAnnotation: function (f, g, c) {
        ...
        q.attr(d, {fill: g.fillColor, stroke: g.lineColor, opacity: this._get([g.fillOpacity, g.opacity]), "stroke-opacity": this._get([g.lineOpacity, g.opacity]), "stroke-width": g.lineWidth, "stroke-dasharray": g.dashStyle || "none"});
        var u;
        if (g.text) {
            var m = g.text;
            var z = 0, h = 0;
            ...
            q.attr(u, {fill: m.fillColor, stroke: m.lineColor, "class": m["class"]})
        }
        ...
        this._raiseEvent("annotation_" + c, {annotation: b})
    }})
})(jqxBaseFramework);