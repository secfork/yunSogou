...
(function (b) {
    ...
    b.extend(b.jqx._jqxTouch.prototype, {defineInstance: function () {
        this.swipeMin = 50;
        this.swipeMax = 500;
        ...
        this._eventsMap = {mousedown: b.jqx.mobile.getTouchEventName("touchstart"), mouseup: b.jqx.mobile.getTouchEventName("touchend"), mousemove: b.jqx.mobile.getTouchEventName("touchmove")};
        ...
        var c;
        if (e < 0) {
            c = {eventId: 3 + d, data: {target: this.host}}
        } else {
            c = {eventId: 4 + d, data: {target: this.host}}
        }
        return c
        ...
        this._tapHoldTimeout = setTimeout(function () {
            if (!c._mouseMoved) {
                c._raiseEvent(1, {target: this.host});
        ...
        if (window.orientation !== this._previousOrientation || this._previousWidth !== screen.width) {
            ...
            this._raiseEvent(7, {orientation: c})
        }
        this._previousOrientation = window.orientation;
        this._previousWidth = screen.width
