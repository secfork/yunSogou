...
(function (a) {
    a.extend(a.jqx._jqxGrid.prototype, {autoresizecolumns: function (z, g) {
        ...
        for (var v = 0; v < this.columns.records.length; v++) {
            ...
            if (d.maxwidth == "auto" || y <= d.maxwidth) {
                ...
                this._raiseEvent(14, {columntext: d.text, column: d.getcolumnproperties(), datafield: d.datafield, displayfield: d.displayfield, oldwidth: h, newwidth: y})
            }
        }
        w.remove();
        ...
        if (d.maxwidth == "auto" || u <= d.maxwidth) {
            ...
            this._updatecolumnwidths();
            this._updatecellwidths();
            this._raiseEvent(14, {columntext: d.text, column: d.getcolumnproperties(), datafield: p, displayfield: d.displayfield, oldwidth: h, newwidth: u});
            this._renderrows(this.virtualsizeinfo);
            if (d._width != undefined) {
                d._width = d.__width
            }
        ...
        if (this.columnsresize) {
            ...
            var e = function () {
                ...
                if (j._resizecolumn != null && j.resizeline != null && j.resizeline.css("display") == "block") {
                    ...
                    j._updatecellwidths();
                    j._raiseEvent(14, {columntext: j._resizecolumn.text, column: j._resizecolumn.getcolumnproperties(), datafield: j._resizecolumn.datafield, oldwidth: q, newwidth: l});
