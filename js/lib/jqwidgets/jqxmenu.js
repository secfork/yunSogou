...
(function (a) {
    ...
    a.extend(a.jqx._jqxMenu.prototype, {defineInstance: function () {
        ...
        var f = function (k) {
            ...
            e._raiseEvent("2", {item: e.minimizedItem[0], event: k});
            e.setSize()
        };
        ...
        h.handleKeyDown = function (k) {
            if (h.keyboardNavigation) {
                ...
                if (k.keyCode == 13) {
                    if (q) {
                        t = true;
                        h._raiseEvent("2", {item: q.element, event: k});
        ...
        a.each(this.items, function () {
            ...
            h.addHandler(n, "click", function (w) {
                ...
                h._raiseEvent("2", {item: r.element, event: w});
                if (!h.autoOpen) {
                    if (r.level > 0) {
            ...
            if (r.subMenuElement != null) {
                ...
                i++;
                var q = a(r.subMenuElement).closest("div.jqx-menu-popup").css({width: parseInt(a(r.subMenuElement).outerWidth()) + parseInt(d[0]) + "px", height: parseInt(a(r.subMenuElement).outerHeight()) + parseInt(d[1]) + "px"});
        ...
        d.remove();
        this.removeHandler(a("#menuWrapper" + this.element.id), "keydown");
        a("#menuWrapper" + this.element.id).remove();
        var b = this;
        this.removeHandler(this.host, "keydown");
        this.removeHandler(this.host, "focus");
...
(function (a) {
    a.jqx._jqxMenu.jqxMenuItem = function (e, d, c) {
        var b = {id: e, parentId: d, parentItem: null, anchor: null, type: c, disabled: false, level: 0, isOpen: false, hasItems: false, element: null, subMenuElement: null, arrow: null, openHorizontalDirection: "right", openVerticalDirection: "down", closeOnClick: true};
        return b
    }
})(jqxBaseFramework);