    ...
    a.extend(a.jqx._jqxListBox.prototype, {defineInstance: function () {
        ...
        for (var j = e; j < v.virtualItemsCount; j++) {
            ...
            if (v.checkboxes) {
                ...
                var o = '<div class="' + v.toThemeProperty("jqx-checkbox-default") + " " + v.toThemeProperty("jqx-fill-state-normal") + " " + v.toThemeProperty("jqx-rc-all") + '"><div style="cursor: pointer; width: 12px; height: 12px;">';
                var w = u.checked ? " " + v.toThemeProperty("jqx-checkbox-check-checked") : "";
                o += '<span style="width: 12px; height: 12px;" class="checkBoxCheck' + w + '"></span>';
                o += "</div></div>";
                i += o;
                i += "</div>"
            }
        ...
        if (d != undefined && d) {
            this._raiseEvent("1", {index: o, type: m, item: s, originalEvent: b});
        ...
        this._raiseEvent("2", {index: j, item: h, oldItem: s, type: m, originalEvent: b});
        this._updateInputSelection();
        return p
