...
(function (a) {
        ...
        this.loadgrouprecords = function (E, H, s, F, I, f, R, G, x) {
            ...
            for (var d = H; d < s; d++) {
                ...
                for (var N = 0; N < L.length; N++) {
                    ...
                    if (k == null) {
                        k = {group: p, subItems: new Array(), subGroups: new Array(), level: 0};
                        K[b++] = k;
                        k.uniqueid = j.generatekey();
                        j.loadedgroupsByKey[p] = k
                    } else {
                        var o = {group: p, subItems: new Array(), subGroups: new Array(), parentItem: k, level: k.level + 1};
    ...
    a.extend(a.jqx._jqxGrid.prototype, {_initgroupsheader: function () {
        ...
        b.dataview.groups = b.groups;
        b.refreshgroups();
        this._raiseEvent(12, {type: "Clear", index: -1, groups: b.groups});
        return true
