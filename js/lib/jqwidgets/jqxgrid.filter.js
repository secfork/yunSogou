...
(function (a) {
    a.extend(a.jqx._jqxGrid.prototype, {_updatefilterrowui: function (f) {
                ...
                if (g.filterable) {
                    ...
                    switch (g.filtertype) {
                        ...
                        case"input":
                            ...
                            a(k.find(".jqx-dropdownlist-state-normal")).jqxDropDownList({theme: l.theme, disabled: l.disabled});
                            break;
                        case"date":
                        case"range":
                            if (this.host.jqxDateTimeInput) {
                                a(k.children()[0]).jqxDateTimeInput({theme: l.theme, disabled: l.disabled, width: c - 10})
                            } else {
                                d(this, k)
                            }
                            break;
                        ...
                        case"checkedlist":
                            if (this.host.jqxDropDownList) {
                                a(k.children()[0]).jqxDropDownList({theme: l.theme, disabled: l.disabled, width: c - 10})
                            } else {
                                d(this, k)
                            }
                            break;
                ...
                switch (f.filtertype) {
                    ...
                    case"input":
                        ...
                        if (this.host.jqxDropDownList) {
                            ...
                            i.jqxDropDownList({selectedIndex: g});
                    ...
                    case"boolean":
                        if (!this.host.jqxCheckBox) {
                            ...
                            a(k.children()[0]).jqxCheckBox({checked: null})
                        }
                        break
                }
            }
        ...
        for (var b = 0; b < this.dataview.filters.length; b++) {
            ...
            d[b] = {filter: this.dataview.filters[b].filter, datafield: c.datafield, displayfield: c.displayfield, filtercolumn: c.datafield, filtercolumntext: c.text}
        }
        return d
        ...
        if (this._hasdatefilter && (E.filtertype !== "list" && E.filtertype !== "checkedlist" && E.filtertype !== "custom")) {
            ...
            if (E.filtertype == "date") {
                ...
                e.append(b);
                var n = function (c) {
                    var i = {calendar: s.gridlocalization, todayString: s.gridlocalization.todaystring, clearString: s.gridlocalization.clearstring};
                    c.jqxDateTimeInput({disabled: s.disabled, localization: i, rtl: s.rtl, width: s._filterpanelwidth - 15, height: 20, value: null, formatString: E.cellsformat, theme: s.theme})
                };
                n(b);
        ...
        if (this.filtermode === "default" && (E.filtertype !== "list" && E.filtertype !== "checkedlist" && E.filtertype !== "custom")) {
            ...
            if (this.filtermode === "excel" || E.filtertype === "list" || E.filtertype === "checkedlist") {
                ...
                if (E.cellsformat) {
                    f.jqxListBox({checkboxes: L, displayMember: E.displayfield, valueMember: E.displayfield + "JQValue", source: v})
                } else {
                    f.jqxListBox({checkboxes: L, displayMember: E.displayfield, valueMember: E.displayfield, source: v})
                }
                if (L) {
        ...
        if (this.filtermode === "default" && !w) {
            t.append(n);
            t.append(v);
            v.jqxDropDownList({_checkForHiddenParent: false, rtl: z.rtl, enableBrowserBoundsDetection: false, selectedIndex: 2, width: p - 15, height: 20, dropDownHeight: 150, dropDownWidth: p - 15, selectionRenderer: y, source: q, theme: z.theme});
            t.append(k);
            var r = new Array();
            r[0] = z.gridlocalization.filterandconditionstring;
            r[1] = z.gridlocalization.filterorconditionstring;
            h.jqxDropDownList({_checkForHiddenParent: false, rtl: z.rtl, enableBrowserBoundsDetection: false, autoDropDownHeight: true, selectedIndex: 0, width: 60, height: 20, source: r, selectionRenderer: y, theme: z.theme});
            t.append(h);
            s.jqxDropDownList({_checkForHiddenParent: false, rtl: z.rtl, enableBrowserBoundsDetection: false, selectedIndex: 2, width: p - 15, height: 20, dropDownHeight: 150, dropDownWidth: p - 15, selectionRenderer: y, source: q, theme: z.theme});
            t.append(s);
            t.append(l)
        } else {
            if (this.filtermode === "excel" || w) {
                ...
                t.append(v);
                v.attr("tabindex", 0);
                v.jqxListBox({rtl: z.rtl, _checkForHiddenParent: false, checkboxes: true, selectedIndex: 2, width: p - 15, height: 120, theme: z.theme});
                var d = true;
